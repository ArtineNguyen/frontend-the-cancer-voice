...
export default function NavBar(props) {
  ...
  return (
    ...
    <Navbar collapseOnSelect variant="light" expand="lg" className="responsive-navbar-nav site-logo">
      <Container>
      ...
      <Navbar className="main-menu">
        ...
        {props.currentUser ? <Nav.Link onClick={()=>logOut()}>Log Out</Nav.Link> : <Nav.Link href="/login">Login</Nav.Link>
        }
